...
const courseSchema = mongoose.Schema({
    ...
    courseDepartment: { type: String, default: 'general', enum: ['general', 'Information Systems', 'Internet Technology', 'Computer Science', 'BIO'], required: 'Please Enter Course Department' },
